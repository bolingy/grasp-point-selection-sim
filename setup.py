...
requirements = ["attrs", "openai", "flask", "open3d", "trimesh", "tensorflow==2.12.0",
                "tensorflow-estimator==2.12.0", "tensorflow-io-gcs-filesystem==0.32.0",
                "autolab-core", "autolab-perception", "visualization", "numpy>=1.23.5", "scipy",
                "matplotlib", "opencv-python", "scikit-learn", "scikit-image", "psutil",
                "gputil", "torch>=1.8.0", "torchvision>=0.9.0", "scipy>=1.5.0",
                "pyyaml>=5.3.1", "pillow", "imageio", "ninja", "gym==0.24.1", "omegaconf",
                "termcolor", "hydra-core>=1.1", "rl-games==1.5.2", "pyvirtualdisplay",
                ]
