...
class ViT_grasp(nn.Module):
    def __init__(
        ...
        *,
        ...
        self.mlp_head = nn.Sequential(nn.LayerNorm(dim), nn.Linear(dim, 58 * 58))
        ...
        self.bn1 = nn.BatchNorm2d(116)
        self.bn2 = nn.BatchNorm2d(58)
...
data_dir = "examples/data/Processed_Data_high_res"
...
folder_name = "dynamo_grasp_high_res_model"
